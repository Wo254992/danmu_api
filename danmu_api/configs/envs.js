...
export class Envs {
  ...
  static ALLOWED_SOURCES = ['360', 'vod', 'tmdb', 'douban', 'tencent', 'youku', 'iqiyi', 'imgo', 'bilibili', 'renren', 'hanjutv', 'bahamut', 'dandan', "sohu", "letv"]; // 允许的源
  ...
  static load(env = {}) {
    ...
    const envVarConfig = {
      ...
      'CONVERT_COLOR': { category: 'danmu', type: 'color-picker', options: ['default', 'white', 'color'], description: '弹幕转换颜色配置：default（不转换）、white（白色）、color（预设随机）或自定义颜色列表' },
