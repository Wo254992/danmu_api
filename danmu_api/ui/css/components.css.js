...
.deploy-config-platform-title {
    color: var(--text-secondary);
    font-weight: 500;
    font-size: 0.875rem;
}

.deploy-config-platform-value {
    color: var(--text-primary);
    font-weight: 600;
    font-size: 0.9375rem;
}
...
.deploy-config-summary.ok {
    border-color: rgba(16, 185, 129, 0.25);
    background: rgba(16, 185, 129, 0.08);
}

.deploy-config-summary.bad {
...
.deploy-config-badge.ok {
    background: rgba(16, 185, 129, 0.12);
    color: rgba(16, 185, 129, 1);
    border-color: rgba(16, 185, 129, 0.25);
}

.deploy-config-badge.bad {
