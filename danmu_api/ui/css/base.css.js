...
.mode-indicator.mode-preview {
    ...
    background: linear-gradient(135deg, var(--bg-secondary) 0%, rgba(156, 163, 175, 0.1) 100%);
}

.mode-indicator.mode-user {
    border-left: 4px solid var(--info-color);
    background: linear-gradient(135deg, var(--bg-secondary) 0%, rgba(59, 130, 246, 0.08) 100%);
}

.mode-indicator.mode-admin {
...
.mode-indicator.mode-preview .mode-value {
    color: var(--gray-500);
}

.mode-indicator.mode-user .mode-value {
    color: var(--info-color);
}

.mode-indicator.mode-admin .mode-value {
