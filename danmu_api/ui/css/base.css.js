...
.top-mode-badge:hover {
    transform: translateY(-2px) scale(1.02);
    box-shadow: var(--shadow-xl);
}

.top-mode-badge-preview {
    background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%);
    border-color: #667eea;
    color: #667eea;
}

.top-mode-badge-normal {
    background: linear-gradient(135deg, rgba(79, 172, 254, 0.1) 0%, rgba(0, 242, 254, 0.1) 100%);
    border-color: #4facfe;
    color: #4facfe;
}

.top-mode-badge-admin {
    background: linear-gradient(135deg, rgba(250, 112, 154, 0.1) 0%, rgba(254, 225, 64, 0.1) 100%);
    border-color: #fa709a;
    color: #fa709a;
}

[data-theme="dark"] .top-mode-badge-preview {
    background: linear-gradient(135deg, rgba(102, 126, 234, 0.2) 0%, rgba(118, 75, 162, 0.2) 100%);
    border-color: #818cf8;
    color: #a5b4fc;
}

[data-theme="dark"] .top-mode-badge-normal {
    background: linear-gradient(135deg, rgba(79, 172, 254, 0.2) 0%, rgba(0, 242, 254, 0.2) 100%);
    border-color: #60a5fa;
    color: #93c5fd;
}

[data-theme="dark"] .top-mode-badge-admin {
...
.top-mode-badge-dot {
    ...
    border-radius: 50%;
    background: currentColor;
    animation: topModePulse 2s ease-in-out infinite;
    flex-shrink: 0;
}

@keyframes topModePulse {
    0%, 100% {
        opacity: 1;
        transform: scale(1);
    }
