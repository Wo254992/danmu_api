...
[data-theme="dark"] .preview-hero-backdrop {
    background: radial-gradient(circle at 30% 20%, rgba(129, 140, 248, 0.12), transparent 50%),
                radial-gradient(circle at 80% 80%, rgba(167, 139, 250, 0.08), transparent 50%);
    opacity: 1;
}
...
[data-theme="dark"] .preview-hero-icon {
    ...
    box-shadow: 0 12px 48px rgba(129, 140, 248, 0.5),
...
[data-theme="dark"] .preview-hero-title {
...
[data-theme="dark"] .preview-stat-card::before {
    background: linear-gradient(135deg, transparent, rgba(129, 140, 248, 0.05), transparent);
}
...
[data-theme="dark"] .stat-icon-status {
    background: linear-gradient(135deg, #34d399 0%, #10b981 100%);
    box-shadow: 0 6px 24px rgba(52, 211, 153, 0.5),
                0 0 0 1px rgba(255, 255, 255, 0.15) inset;
}
...
[data-theme="dark"] .stat-icon-status.status-warning {
    background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%);
    box-shadow: 0 6px 24px rgba(251, 191, 36, 0.5),
                0 0 0 1px rgba(255, 255, 255, 0.15) inset;
}

.stat-icon-status.status-warning .status-pulse-ring {
...
[data-theme="dark"] .stat-icon-status.status-error {
    background: linear-gradient(135deg, #f87171 0%, #ef4444 100%);
    box-shadow: 0 6px 24px rgba(248, 113, 113, 0.5),
                0 0 0 1px rgba(255, 255, 255, 0.15) inset;
}

.stat-icon-status.status-error .status-pulse-ring {
