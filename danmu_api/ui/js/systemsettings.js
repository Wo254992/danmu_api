    ...
    dialog.innerHTML = \`
        <div class="custom-dialog-container">
            ...
            <div class="custom-dialog-actions">
                ...
                <button type="button" class="btn btn-warning" onclick="closeImportModeDialog('replace', \${JSON.stringify(colors)})">
                    🔄 替换
                </button>
                <button type="button" class="btn btn-primary" onclick="closeImportModeDialog('append', \${JSON.stringify(colors)})">
                    ➕ 追加
                </button>
            </div>
        </div>
...
// 新增：关闭导入方式对话框并执行操作
window.closeImportModeDialog = function(mode, colorsJson) {
