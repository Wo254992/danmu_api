...
const CLIENT_CONFIG = {
  ...
  baseQuery: {
    iid: "3102162718837211",
    device_id: "3102162718570971",
    channel: "googleplay",
    device_type: "PJZ110",
    cdid: "c9013a24-2089-4333-a73a-950a4963fe5d",
    aid: "8662",
    app_name: "novelread",
    version_code: "72932",
    ...
    rom_version: "V433IR+release-keys",
  },
  sessionHeaders: {
    cookie: "store-region=cn-zj; store-region-src=did; install_id=3102162718837211",
    "x-tt-token": "",
    "user-agent": "com.phoenix.read/72932 (Linux; U; Android 13; zh_CN; PJZ110; Build/V433IR;tt-ok/3.12.13.20)",
